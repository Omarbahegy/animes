...
@section('pageTilte') Home page @endsection
    ...
    <div class="row">
        ...
        <div class="span8 blog">
            ...
            <article>
                ...
                <div class="post-summary">
                    <a href="blog-single.htm"><img src={{ asset('Theme/img/gallery/post-img-1.jpg') }} alt="Post Thumb"></a>
        ...
        <div class="span4 sidebar">
            ...
            <ul class="popular-posts">
                <li>
                    <a href="#"><img src={{ asset('Theme/img/gallery/gallery-img-2-thumb.jpg') }} alt="Popular Post"></a>
